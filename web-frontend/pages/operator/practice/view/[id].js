...
export default function View() {
  ...
  return (
    <div className="mt-12">
      <SectionQuestion dataExams={dataExams} indexActiveSection={indexActiveSection} urlBack="/operator/practice" type="Practice" setActiveSection={(data) => setActiveSection(data)} setIndexActiveSection={(data) => setIndexActiveSection(data)} activeSection={activeSection} />
    </div>
  )
}
