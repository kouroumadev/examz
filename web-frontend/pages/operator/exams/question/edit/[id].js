...
import Layout from "../../../../../Layout/Layout";
 ...
 export default function Edit() {
   return <EditQuestion role="operator" />
}
...
//   const getDetail = useCallback(async (questionId, examId) => {
//     setIdExamPractice(examId)
//     await apiExam.detailQuestion(questionId)
//       .then((res) => {
//         const arr = []
...
//           setValue(`${field}[is_required]`, data.items[i].is_required)
...
//                       <div className="w-full">
//                           <p>Compulsory</p>
//                           <Select bg='white' {...register(`is_required`)} size="md" variant='outline' iconColor="blue">
...
//                         <Quill type={s3.QUESTION_ANSWER} data={itemQuestion.instruction} register={(data) => setDataForm(`instruction`, data)} />
//                       </div>
//                     </div>
//                     <div className="mt-4">
...
//                       )}</p>
//                       <div className="w-full  bg-white rounded-lg " style={{ lineHeight: 2 }} >
//                         <Quill  type={s3.QUESTION_ANSWER} data={itemQuestion.paragraph} register={(data) => setDataForm(`paragraph`, data)} />
//                       </div>
//                     </div>
//                   </>
//                 )}
...
//                         <div className="w-full">
//                           <p>Compulsory</p>
//                           <Select bg='white' {...register(`question_items[${indexEachQuestion}].is_required`)} size="md" variant='outline' iconColor="blue">
//                             <option value="1">Compulsory</option>
//                             <option value="0">Not Compulsory</option>                    
//                           </Select>
//                         </div>
...
//                         )}</p>
//                         <div className="w-full  bg-white rounded-lg " style={{ lineHeight: 2 }} >
//                           <Quill type={s3.QUESTION_ANSWER} subType={s3.QUESTION} data={getValues(`question_items[${indexEachQuestion}].question`)} register={(data) => setDataForm(`question_items[${indexEachQuestion}].question`, data)} />
//                         </div>
//                       </div>
//                       <div className="mt-4">
...
//                                        type="text" className="bg-white form border w-full rounded p-2 h-full m-1"
//                                     />
//                                   ) : (
//                                     <div className="w-full  bg-white rounded-lg " style={{lineHeight: 2}}>
...
//                                   <div className="m-auto cursor-pointer text-blue-1" onClick={() => {
//                                     const temp = questions
//                                     temp.map((itemQ) => {
//                                       if (itemQ.id === itemQuestion.id) {
//                                         itemQ.items.map((b) => {
...
//                             )}</p>
//                             <input type="number" step="0.01" className=" w-full form border p-2 rounded" placeholder="0" {...register(`question_items[${indexEachQuestion}].mark`)} readOnly/>
//                           </div>
//                           <div className="w-full">
//                             <p>Negative Marking {errors && (
//                               <span className="text-red-1 text-sm">{errors[`question_items.${indexEachQuestion}.negative_mark`]}</span>
//                             )}</p>
//                             <input type="number" step="0.01" className="w-full form border p-2 rounded" placeholder="0" {...register(`question_items[${indexEachQuestion}].negative_mark`)} readOnly />
//                           </div>
//                         </div>
//                       </div>
//                     </div>
...
//   const query = context.query.id.split("#")[0];
//   const examId = query.split('=')[1]
//   const questionId = query.split("_id")[0]
//   return { props: { questionId: questionId, examId: examId } }
// }
