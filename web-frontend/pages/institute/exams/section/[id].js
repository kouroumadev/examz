import CreateQuestion from "../../../../components/Common/CreateQuestion";
import Layout from "../../../../Layout/Layout";

export default function Create() {
  return <CreateQuestion role="institute" />
}
...
//                               <div className="bg-blue-6 flex gap-2 h-full w-full border rounded cursor-pointer">
//                                     <div className="flex gap-4 h-9">
//                                         <div className="my-auto ml-2">
//                                             <input
//                                                 {...register(`questions[${indexQuestion}].question_items[${indexEachQuestion}].is_required`, isRequired ? '1' : '0')}
...
//                                                 // {...register(`questions[${indexQuestion}].question_items[${indexEachQuestion}].is_required`, isRequiredValue)}
