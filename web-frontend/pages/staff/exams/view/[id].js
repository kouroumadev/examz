...
export default function View() {
  ...
  return (
    <div className="mt-12">
      <SectionQuestion dataExams={dataExams} indexActiveSection={indexActiveSection} urlBack="/staff/exams" type="Exams" setActiveSection={(data) => setActiveSection(data)} setIndexActiveSection={(data) => setIndexActiveSection(data)} activeSection={activeSection} />
    </div>
  )
}
